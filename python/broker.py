...
def task_ledsOff():
    client.publish('/raspberry/1/incoming','LEDS_OFF',2)

def task_ledsOn():
    client.publish('/raspberry/1/incoming','LEDS_ON',2)

def task_turnHead():
    client.publish('/raspberry/1/incoming','SERVO_SLOW, 1, 73, 170',2)

def task_turnHeadBack():
    client.publish('/raspberry/1/incoming','SERVO_SLOW, 1, 170, 73',2)
